...
<div class="content">
    <div class="account-creation-container">
        ...
        <form id="account-creation-form" action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-section active" data-step="1">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="age" name="age" value="{{old('age')}}" class="form-control" min="18" max="100" required>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" id="contact" name="contact" value="{{old('contact')}}" class="form-control" pattern="[0-9]{11}" required>
            ...
            <div class="form-section" data-step="2">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="file" name="img" class="form-control" accept="image/*">
                </div>
            </div>
